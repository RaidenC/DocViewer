      ...
      {activityFeed.length === 0 ? (
        ...
        <div className="space-y-1.5 max-h-40 overflow-y-auto pr-1">
          {activityFeed.map((activity, index) => (
            <div
              key={index}
              className={`flex items-center gap-2 text-xs p-2 bg-white rounded-lg border border-slate-100 shadow-sm hover:border-indigo-200 ${
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1 mt-0.5">
                  <span className="font-mono text-indigo-600 bg-indigo-50 px-1 rounded truncate max-w-[80px]" title={activity.query}>
                    "{activity.query}"
                  </span>
